...
# Unit-Tests fuer Bk2Kombi::ScoreShot — pure shot evaluator.
#
...
class Bk2Kombi::ScoreShotTest < ActiveSupport::TestCase
  # ---------------------------------------------------------------------------
