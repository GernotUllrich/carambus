...
class PlayerClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_class" do
    assert_difference('PlayerClass.count') do
      post player_classes_url, params: { player_class: { discipline_id: @player_class.discipline_id, shortname: @player_class.shortname } }
    end
  ...
  test "should update player_class" do
    patch player_class_url(@player_class), params: { player_class: { discipline_id: @player_class.discipline_id, shortname: @player_class.shortname } }
