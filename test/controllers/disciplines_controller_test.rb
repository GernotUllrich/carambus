...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { data: @discipline.data, name: @discipline.name, super_discipline_id: @discipline.super_discipline_id, table_kind_id: @discipline.table_kind_id } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { data: @discipline.data, name: @discipline.name, super_discipline_id: @discipline.super_discipline_id, table_kind_id: @discipline.table_kind_id } }
