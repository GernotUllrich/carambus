...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { ba_id: @season.ba_id, data: @season.data, name: @season.name } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { ba_id: @season.ba_id, data: @season.data, name: @season.name } }
