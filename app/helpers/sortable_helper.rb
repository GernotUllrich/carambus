module SortableHelper
  def sortable(scope, column, title = nil, request_params = {}, options = {})
    begin
    params = request_params.present? ? request_params : params
    ...
    link_params.merge!(controller: scope.klass.name.underscore.pluralize, action: "index")
