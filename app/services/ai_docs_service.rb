...
class AiDocsService < ApplicationService
  ...
  def call
    ...
    return error_response("KI-Dokumentations-Suche nicht konfiguriert") unless anthropic_configured?
    ...
    begin
      ...
      # 2. Ask Claude with documentation context
      ai_response = ask_claude_with_context(relevant_docs)
  ...
  def ask_claude_with_context(docs)
