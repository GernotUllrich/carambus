class DisciplineTournamentPlansController < ApplicationController
  ...
  def index
    @pagy, @discipline_tournament_plans = pagy(DisciplineTournamentPlan.sort_by_params(params[:sort], sort_direction))
  ...
  def discipline_tournament_plan_params
    params.require(:discipline_tournament_plan).permit(:discipline_id, :tournament_plan_id, :points, :innings, :players, :player_class)
  end
end
