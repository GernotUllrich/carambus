class RegistrationListCcsController < ApplicationController
  before_action :set_registration_list_cc, only: [:show, :edit, :update, :destroy]
  ...
  def registration_list_cc_params
    params.require(:registration_list_cc).permit(:cc_id, :context, :name, :branch_cc_id, :season_id, :discipline_id, :category_cc_id, :deadline, :qualifying_date, :data, :status)
  end
end
