class GamePlanCcsController < ApplicationController
  before_action :set_game_plan_cc, only: [:show, :edit, :update, :destroy]
  ...
  def game_plan_cc_params
    params.require(:game_plan_cc).permit(:cc_id, :name, :data, :branch_cc_id, :discipline_id, :mp_won, :mb_draw, :mp_lost, :znp, :vorgabe, :plausi, :pez_partie, :bez_brett, :rang_partie, :rang_mgd, :rang_kegel, :ersatzspieler_regel, :row_type_id)
  end
end
