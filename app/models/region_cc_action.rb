class RegionCcAction
  ...
  def self.get_base_opts_from_environment
    ...
    karambol_ba_ids = [1831, 2344, 3719, 3718, 4190, 4241, 4245, 4872, 5493, 6202, 6901, 6894, 4871, 5492, 6211, 1826, 2340, 3783, 4242, 4244, 6895, 6891, 7562, 7572, 7574, 7579, 8243, 8245, 609, 4885, 4869, 5498, 5504, 6204, 6218, 8251, 8242, 1156, 1159, 576]
