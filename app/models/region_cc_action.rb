class RegionCcAction
  ...
  def self.get_base_opts_from_environment
    ...
    karambol_ba_ids = [1831, 2344, 3719, 3718, 4190, 4241, 4245, 4872, 5493, 6202, 6889, 6894, 7571, 7562, 4886, 5499, 6215, 1826, 2340, 4440, 4242, 6895, 6891, 7572, 7574, 8258, 8243, 576, 609, 4885, 4869, 5498, 5504, 6204, 6218, 8251, 8242, 1156, 1159]
