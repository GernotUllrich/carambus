  ...
  RULES = {
    ...
    "M01": {
      "g1": {
        ...
        "sq": {
          "r1": {
            "t-rand-1-4": ['3-12', '2-11', '6-9', '5-8']
          },
          "r2": {
            "t-rand-1-4": ['1-10', '9-12', '4-7', '3-6']
          },
          "r3": {
            "t-rand-1-4": ['8-11', '7-10', '2-5', '1-4']
          },
          "r4": {
            "t-rand-1-3": ['3-9', '2-8', '6-12']
          },
          "r5": {
            "t-rand-1-3": ['5-11', '1-7', '4-10']
          },
        },
      },
      "RK": [
    ...
    "M02": {
      "g1": {
        ...
        "sq": {
          "r1": {
            "t-rand-1-3": ['1-4', '2-8', '3-12']
          },
          "r2": {
            "t-rand-1-3": ['1-7', '2-11', '3-6']
          },
          "r3": {
            "t-rand-1-3": ['1-10', '2-5', '3-9']
          },
          "r4": {
            "t-rand-1-3": ['4-7', '5-11', '9-12']
          },
          "r5": {
            "t-rand-1-3": ['4-10', '6-9', '8-11']
          },
          "r6": {
            "t-rand-1-3": ['5-8', '6-12', '7-10']
          },
        }
      },
      "RK": [
