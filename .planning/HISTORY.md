...
| 260422-pz0 | 2026-04-23 | Merge `origin/master` into `feature/training-system` per Claudia handoff (training-system lane) | `8aabcab9` |
| 260423-k9v | 2026-04-23 | Fix `Season.current_season` typo + remove class-level caching (follow-up to 260422-pz0 flake) (training-system lane) | `372c6344` |
| 260423-qvm | 2026-04-23 | Admin Show-page 500 fix (Administrate × Rails 7.1 shim) + P1 controller M2M cleanup + P2 smoke tests (training-system lane) | `96d5f1b5` |
