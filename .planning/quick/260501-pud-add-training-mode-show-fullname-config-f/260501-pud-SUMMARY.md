...
1. Edit BOTH files in the BCW deployment checkout:
   - `/Users/gullrich/DEV/carambus/carambus_bcw/config/carambus.yml.erb`
   - `/Users/gullrich/DEV/carambus/carambus_bcw/config/carambus.yml` (gitignored — must be synced manually)
