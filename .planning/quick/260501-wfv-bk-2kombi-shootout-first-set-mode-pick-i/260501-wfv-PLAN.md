...
DO NOT change line ordering or any other code in either reflex.
  ...
  <verify>
    <automated>cd /Users/gullrich/DEV/carambus/carambus_bcw && bundle exec standardrb app/reflexes/table_monitor_reflex.rb && grep -c '@table_monitor.data.delete("bk2_state")' app/reflexes/table_monitor_reflex.rb | grep -q '^2$' && echo "OK: 2 delete sites"</automated>
  </verify>
  <done>
...
DO NOT mock or stub anything — this is a pure data-roundtrip test against real `initialize_bk2_state!`.
  ...
  <verify>
    <automated>cd /Users/gullrich/DEV/carambus/carambus_bcw && bin/rails test test/services/bk2/advance_match_state_test.rb -v 2>&1 | tail -20</automated>
  </verify>
  <done>
