...
<task type="auto" tdd="true">
  ...
  <verify>
    <automated>cd /Users/gullrich/DEV/carambus/carambus_bcw && bin/rails test test/models/table_monitor_test.rb 2>&1 | tail -30</automated>
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    <automated>cd /Users/gullrich/DEV/carambus/carambus_bcw && bundle exec erblint app/views/locations/_quick_game_buttons.html.erb && grep -n "bk2_sp_max_innings" config/carambus.yml.erb config/carambus.yml app/views/locations/_quick_game_buttons.html.erb</automated>
  </verify>
  <done>
...
<task type="auto" tdd="true">
  ...
  <verify>
    <automated>cd /Users/gullrich/DEV/carambus/carambus_bcw && bin/rails test test/models/table_monitor_test.rb 2>&1 | tail -15</automated>
  </verify>
  <done>
