...
Plans:
- [x] `38.7-01-discipline-defaults-and-fixtures-PLAN.md` — Seed `tiebreak_on_draw=true` on BK-2 + BK-2kombi central Discipline records (D-06); mirror into `test/fixtures/disciplines.yml`. Other BK-* and Karambol/Snooker/Pool stay sparse (default false). Wave 1. (SUMMARY: `38.7-01-SUMMARY.md`)
