...
- `/Users/gullrich/DEV/carambus/carambus_api/mkdocs.yml` - expanded exclude_docs (5 patterns), Services nav block (8 entries), 9 DE nav_translations entries
- `/Users/gullrich/DEV/carambus/carambus_api/docs/developers/developer-guide.en.md` - fixed cross-language link at line 455 (.de.md -> .md)
- `/Users/gullrich/DEV/carambus/carambus_api/docs/developers/rake-tasks-debugging.de.md` - replaced 3 out-of-docs-root hyperlinks with plain text
- `/Users/gullrich/DEV/carambus/carambus_api/docs/developers/rake-tasks-debugging.en.md` - replaced 3 out-of-docs-root hyperlinks with plain text
- `/Users/gullrich/DEV/carambus/carambus_api/docs/reference/api.de.md` - removed broken API.md link, replaced with "siehe oben"
- `/Users/gullrich/DEV/carambus/carambus_api/docs/reference/api.en.md` - removed broken API.md link, replaced with "see above"
