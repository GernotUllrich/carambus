...
key-files:
  created:
    - /Users/gullrich/DEV/carambus/carambus_master/docs/stylesheets/print.css
...
- `/Users/gullrich/DEV/carambus/carambus_master/docs/stylesheets/print.css` (created, 3102 bytes) — Shared `@media print` stylesheet
- `/Users/gullrich/DEV/carambus/carambus_master/mkdocs.yml` (modified, +1 line) — `extra_css` list now references `stylesheets/print.css`
...
- Files verified on disk:
  - FOUND: /Users/gullrich/DEV/carambus/carambus_master/docs/stylesheets/print.css
  - FOUND: /Users/gullrich/DEV/carambus/carambus_api/.planning/phases/35-printable-quick-reference-card/35-01-BASELINE.txt
  - FOUND: /Users/gullrich/DEV/carambus/carambus_master/mkdocs.yml (contains `stylesheets/print.css`)
