...
1. Start local mkdocs dev server:
   ```bash
   cd /Users/gullrich/DEV/carambus/carambus_master && mkdocs serve -a localhost:8000
   ```
...
- `/Users/gullrich/DEV/carambus/carambus_master/docs/managers/tournament-management.{de,en}.md` — walkthrough anchor target file
