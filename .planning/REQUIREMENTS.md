...
- [ ] **DOC-ACC-05**: Walkthrough is restructured to honestly distinguish manager-action phases from passive/observation phases. Current linear "Schritt 1..14" framing (which overstates manager activity during game play per F-36-30) is replaced with an accurate model.
...
| DOC-ACC-01 | Phase 36a | Pending |
| DOC-ACC-02 | Phase 36a | Pending |
| DOC-ACC-03 | Phase 36a | Pending |
| DOC-ACC-04 | Phase 36a | Pending |
| DOC-ACC-05 | Phase 36a | Pending |
