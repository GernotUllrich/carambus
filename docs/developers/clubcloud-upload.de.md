...
Der Upload erfolgt in `app/services/tournament_monitor/result_processor.rb` nach Spielabschluss:
...
def self.upload_game_to_cc(table_monitor)
  ...
  # Hinweis: Form-Keys sind Symbole und entsprechen der ClubCloud-API createErgebnisSave.php
...
region_cc.userpw                      # Admin-Passwort
```
...
- [Manager-Dokumentation: ClubCloud Integration](../managers/clubcloud-integration.md)
- [Manager-Dokumentation: Einzelturnier-Verwaltung](../managers/single-tournament.md)
- [API-Referenz](../reference/api.md)
