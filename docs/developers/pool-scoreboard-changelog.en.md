...
**File:** `docs/players/pool_scoreboard_benutzerhandbuch.de.md`
...
- `docs/players/pool_scoreboard_benutzerhandbuch.de.md` - New user manual
- `docs/developers/pool-scoreboard-changelog.en.md` - This file
