...
aus, wenn das in der Szenario-Konfiguration eingeschaltet ist (`serve_tournament_app`). Die App gehört zum
Carambus-Repository und kommt mit jedem Deploy mit. Sie meldet sich mit einem Dienstkonto an, das der Admin am Server
anlegt ([Anleitung](../managers/tournament-app.md#voraussetzungen)).
