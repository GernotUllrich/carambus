...
if this is switched on in the scenario configuration (`serve_tournament_app`). The app is part of the Carambus
repository and ships with every deploy. It signs in with a service account that the admin creates on the server
([guide](../managers/tournament-app.md#voraussetzungen)).
