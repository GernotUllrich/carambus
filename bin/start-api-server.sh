...
# Start API mode server
# This script starts the Rails server in API mode on port 3000
...
# Start the server
log "Starting API mode server on port $PORT..."
log "Environment: $ENVIRONMENT"
log "Database: carambus_api_development"
log "Log file: log/development-api.log"
log ""
...
# Start the server with the API environment
