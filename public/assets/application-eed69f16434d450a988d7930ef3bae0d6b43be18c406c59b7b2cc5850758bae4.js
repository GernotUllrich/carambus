    ...
    applyFilters(event) {
      ...
      for (const [name3, value] of formData.entries()) {
        if (name3 !== "global" && !name3.endsWith("_operator") && value) {
          ...
          const isReferenceField = ["region_shortname", "club_shortname", "league_shortname", "party_shortname"].includes(name3);
        ...
        setTimeout(() => {
          if (regionSelect) {
            ...
            if (currentPath.includes("/party_games")) {
              reflexName = "change->FilterPopupReflex#filter_leagues_by_region_for_party_games";
...
@webcomponents/template/template.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application.js-7c78379b8fdcefb9fb9685113f28f5caa1a534e6f7b546ffe70dcec1b244b5fa.map
//!
;
