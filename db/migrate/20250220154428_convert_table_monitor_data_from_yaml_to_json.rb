class ConvertTableMonitorDataFromYamlToJson < ActiveRecord::Migration[7.2]
  ...
  def up
    TableMonitor.find_each do |table_monitor|
      ...
      raw_value = table_monitor.read_attribute_before_type_cast("data")
  ...
  def down
    TableMonitor.find_each do |table_monitor|
      ...
      # table_monitor.update_column("data", yaml_str)
    end
  end
end
